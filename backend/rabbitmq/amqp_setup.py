...
# Get RabbitMQ credentials from environment variables or use defaults
...
create_queue(
    ...
    routing_key="reservation.confirmation",
)
create_queue(
    channel=channel,
    exchange_name=exchange_name,
    queue_name="Reservation_Cancellation",
    routing_key="reservation.cancellation",
)
create_queue(
    channel=channel,
    exchange_name=exchange_name,
